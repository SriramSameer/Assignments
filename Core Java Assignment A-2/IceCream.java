...
public class IceCream extends DessertItem {
	...
	public void setNumberOfCoops(int numberOfScoops) {
	...
	public void setPricePerScoop(double toppingPrice) {
		this.toppingPrice = topppingPrice;
	}
	...
	{
		String s = String.format("%50s %2f\n\t%d scoops, getnName(),getCost()/100,numberOfScoops,pricePerScoop,toppingPrice);"
				+ "return s;
	}
